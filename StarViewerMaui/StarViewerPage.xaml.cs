...
public partial class StarViewerPage : ContentPage
{
    ...
    ///     次の星座へ移動する日
    /// </summary>
    private Horoscope.HoroscopeInfos horoNext = null;
    ...
    private void Update()
    {
        ...
        //次の星座へ移動する日を求めるのは時間が係るので１回限り読み込むことにする
        if (this.horoNext == null)
        {
            horoNext = horoInfos.GetNextSignInfo();
        }
